...
const $$Icon = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const icons = /* #__PURE__ */ Object.assign({"/src/core/icons/arrow-left.svg": () => import('./arrow-left_B4wSaGo_.mjs').then(m => m["default"]),"/src/core/icons/command.svg": () => import('./command_GmbVtEQz.mjs').then(m => m["default"]),"/src/core/icons/folder.svg": () => import('./folder_Cn1h7PUI.mjs').then(m => m["default"]),"/src/core/icons/github.svg": () => import('./github_BKRlQbgr.mjs').then(m => m["default"])
...
const $$Navlink = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Navlink;
  const { href, text, icon, target } = Astro2.props;
...
const $$Menubar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<button aria-label="Command" id="menu-button" data-astro-cid-edh4vpt2> ${renderComponent($$result, "Icon", $$Icon, { "name": "command", "data-astro-cid-edh4vpt2": true })} </button> ${renderComponent($$result, "Command", $$Command, { "data-astro-cid-edh4vpt2": true })}  `;
